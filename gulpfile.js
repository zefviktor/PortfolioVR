...
gulp.task('slick', function () {
    return gulp.src('assets/slick/**/*')
        .pipe(gulp.dest('build/slick'))
        .pipe(browserSync.reload({stream: true}))
});

gulp.task('highslide', function () {
    return gulp.src('assets/highslide/**/*')
        .pipe(gulp.dest('build/highslide'))
        .pipe(browserSync.reload({stream: true}))
});



gulp.task('watch', gulp.series('html', 'pug', 'img', 'js', 'sass', 'fonts', 'min-css', 'slick', 'highslide',  (done) => {
    // browserSync.init({
    ...
    gulp.watch('assets/slick/**/*', gulp.parallel('slick'));
    gulp.watch('assets/highslide/**/*', gulp.parallel('highslide'));
    done();
}));
